        ...
        <div class="main">
          ...
          GROUP BY type";
                              ...
                              WHERE class_id = :class_id";
                                ...
                                $activityTypes = ['midterm' => ['quiz' => [], 'aaa' => [], 'exam' => []], 'final' => ['quiz' => [], 'aaa' => [], 'exam' => []]];
                                foreach ($activities as $activity) {
                                    if ($activity['term'] === 'midterm') {
                                        if ($activity['type'] === 'quiz')
                                            $activityTypes['midterm']['quiz'][] = $activity;
                                        ...
                                        if ($activity['type'] === 'quiz')
                                            $activityTypes['final']['quiz'][] = $activity;
                                        elseif (in_array($activity['type'], ['assignment', 'activity']))
                                ...
                                foreach ($students as $student) {
                                    ...
                                    foreach (['midterm', 'final'] as $term) {
                                        ...
                                        $quizScore = $totalQuizMax > 0 ? ($totalQuizScore / $totalQuizMax) * 100 : 0;
                                        ...
                                        $lectureGrade = ($majorExamScore * 0.4) + ($quizScore * 0.3) + ($aaaScore * 0.3);
                                ...
                                <table border="1" class="print-text" id="class"
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <th class="border-1" colspan="<?php echo $totalQuizzes ?> ">Quizzes
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <?php foreach ($quizzes as $index => $quiz): ?>
                                            <th class="border-1">Q<?= $index + 1 ?> <br> (<?= $quiz['max_points'] ?>)</th>
                                        <?php endforeach; ?>
                                        <th class="border-1"><?= $totalPoints['quiz'] ?></th>
                                        <?php foreach ($assignments as $index => $assignment): ?>
                                            <th class="border-1">ASS<?= $index + 1 ?> <br>
                                                (<?= $assignment['max_points'] ?>)</th>
                                        <?php endforeach; ?>
                                        <th class="border-1">
                                            TOTAL <small>(ASS.)</small>
                                            <hr>
                                            <?= $totalPoints['assignment'] ?>
                                        </th>
                                        <th class="border-1">Attendance</th>
                                        <th class="border-1">TOTAL <small>(ATT.)</small>
                                            <hr> <?php echo $totalMeetings ?>
                                        </th>
                                        <?php foreach ($activitiesAll as $index => $activity): ?>
                                            <th class="border-1">ACT<?= $index + 1 ?> <br> (<?= $activity['max_points'] ?>)
                                            </th>
                                        <?php endforeach; ?>
                                        <th class="border-1">
                                    ...
                                    <?php foreach ($male_students as $student): ?>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            echo "<td class='border-1'>  $quizTotal</td>";
                                            ...
                                            echo "<td class='border-1'>$activityTotal</td>";
                                    ...
                                    <tr>
                                        <th colspan="20" class="text-center"
                                            style="background-color: grey; color: white;">Female</th>
                                    </tr>
