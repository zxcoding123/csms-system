                            ...
                            <div class="card-body">
                                ...
                                <div class="row text-center">
                                    <div class="col linkism">
                                        <a class="linker"
                                            href="subject_activities.php?url=announcements&class_id=<?php echo $class_id ?>&subject_id=<?php echo $subject_id ?>">Announcements</a>
                                    </div>
                                    <div class="col linkism">
                                        <a class="linker"
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col">
                                                                        ...
                                                                        <p class="text-muted mb-0">
                                                                            Create and manage announcements for this subject.
                                                                        </p>
...
");
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header d-flex justify-content-between align-items-center">
                                                                        <strong>Posted Announcements</strong>
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                <li>
                                                                                                    <button class="dropdown-item text-danger"
                                                                                                        onclick="confirmDelete(<?= (int)$a['id'] ?>)">
...
<div class="modal fade" id="createAnnouncementModal" tabindex="-1"
    aria-labelledby="createAnnouncementLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form id="announcementForm"
                action="processes/teachers/subject_posts/create.php"
                method="POST">
...
<?php
    unset($_SESSION['STATUS'], $_SESSION['STATUS_MSG']);
endif;
?>
...
<script>
    ...
    document.getElementById('announcementForm')
        .addEventListener('submit', function(e) {
            const content = announcementEditor.getData().trim();
            if (!content) {
                e.preventDefault();
                alert('Announcement content is required.');
                announcementEditor.editing.view.focus();
            }
        });
</script>
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href =
                    'processes/teachers/subject_posts/delete.php?id=' + id;
            }
        });
    }
</script>
