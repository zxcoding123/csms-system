...
if (
    ...
    $exercises = floatval($data['exercises']);
    ...
    try {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $insertQuery = "
                INSERT INTO laboratory_rubrics (class_id, major_exam, exercises, assignments_activities_attendance)
                VALUES (:class_id, :major_exam, :exercises, :assignments_activities_attendance)
            ";
